...
Note due to limitations in vs code; local html can be loaded within vs code but external websites only work when loaded in external browser (see settings).
